...
module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        endpoint:
          'https://outlook.us7.list-manage.com/subscribe/post?u=7ca776400119629a9e4bff5b0&amp;id=c3649baaab', // string; add your MC list endpoint here; see instructions below
